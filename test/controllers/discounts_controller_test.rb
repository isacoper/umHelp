...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { type: @discount.type, value: @discount.value } }, as: :json
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { type: @discount.type, value: @discount.value } }, as: :json
    assert_response 200
  end
